   ...
   .table-responsive {
    ...
    <div id="div_content">
        ...
        <p id="paragraph"
          ...
          Your Bill Amount Is Sent Your Mail
        </p>
    </div>
        ...
        <div class="container-xl">
            <div class="table-responsive">
                <div class="table-wrapper">
                    ...
                    <h1 style="font-size:50px;">Bill Details</h1>
                            ...
                            <div class="col-sm-6">
        <div class="fakeimg" style="height:40px;"></div>
                  ...
                  <input class="form-control me-2" type="search" placeholder="Search InvoiceID" name="search" aria-label="Search InvoiceID">
...
.btn-labeled>b {
    ...
    <script>
        $(document).ready(function() {
            $(document).ajaxComplete(function() {
                alert("Dear Customer ,You Should pay Before next month ");
            });
    ...
    <style>
html, body {
    background-image: url('file:///C:/Users/LENOVO/git/Y3.S1.WD.IT.-02.2.G1.200.PAF/Billings%20Service2/src/main/webapp/img/paf4.jpg');
